...
# 创建一个椭圆轨道实例
ellipse_orbit = Orbit.elliptical(mu = 398600.436, rp = 3800.0, ra = 42000.0).at(5800)
...
# 创建一个圆形轨道实例
circular_orbit = Orbit.circular(mu=398600.436, r=6371.0) # 使用地球的标准重力参数和地球半径

# 打印圆形轨道的属性
print(circular_orbit)

# 访问和打印轨道的属性
print("椭圆轨道的半径:", ellipse_orbit.r)
print("圆形轨道的速度:", circular_orbit.v)
print("圆形轨道的h:", circular_orbit.h)
print()

print(ellipse_orbit.a)
print(ellipse_orbit.b)
print(ellipse_orbit.rpe)
print(ellipse_orbit.rap)
print(ellipse_orbit.p)
print(ellipse_orbit.vpe)
print(ellipse_orbit.vap)

print(ellipse_orbit.e)
print(ellipse_orbit.period)
print(ellipse_orbit.cos_nu)
print(circular_orbit.cos_E)
